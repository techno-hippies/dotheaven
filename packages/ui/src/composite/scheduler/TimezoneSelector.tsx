  ...
  return (
    <div class={cn('space-y-6', props.class)}>
      ...
      <div class="flex items-center justify-between">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger>
            <button class="flex items-center gap-2 text-base text-[var(--text-primary)] hover:text-[var(--accent-blue)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-blue)] focus-visible:ring-offset-2 rounded-md">
