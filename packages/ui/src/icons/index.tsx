...
export const CompassFill: Component<IconProps> = (props) => (
  <svg class={props.class ?? 'w-6 h-6'} viewBox="0 0 256 256" fill="currentColor">
...
export const Flag: Component<IconProps> = (props) => (
  <svg class={props.class ?? 'w-6 h-6'} viewBox="0 0 256 256" fill="currentColor">
    <path d="M34.76,42A8,8,0,0,0,32,48V216a8,8,0,0,0,16,0V171.77c26.79-21.16,49.87-9.75,76.45,3.41,16.4,8.11,34.06,16.85,53,16.85,13.93,0,28.54-4.75,43.82-18a8,8,0,0,0,2.76-6V48a8,8,0,0,0-13.27-6C178.39,70.44,145.77,50.12,112.45,34,78.52,17.57,48.21,3.92,34.76,42ZM208,161.73C185.58,181.3,163.84,171.4,140.55,159.85c-18.07-8.94-37.53-18.58-57.57-15.07A61.56,61.56,0,0,0,48,155.32V50.41C70.39,30.87,92.08,40.79,115.33,52.31c20.68,10.23,42.88,21.25,66.41,14.49A76.47,76.47,0,0,0,208,52.41Z" />
  </svg>
)

export const Prohibit: Component<IconProps> = (props) => (
  <svg class={props.class ?? 'w-6 h-6'} viewBox="0 0 256 256" fill="currentColor">
    <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm88,104a87.56,87.56,0,0,1-20.41,56.28L71.72,60.41A88,88,0,0,1,216,128ZM40,128A87.56,87.56,0,0,1,60.41,71.72L184.28,195.59A88,88,0,0,1,40,128Z" />
  </svg>
)
