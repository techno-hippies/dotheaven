  ...
  'inline-flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 cursor-pointer',
  {
    variants: {
      variant: {
        ...
        send: 'bg-[var(--accent-blue)] hover:bg-[var(--accent-blue-hover)] text-white rounded-md disabled:bg-[var(--bg-highlight)] disabled:text-[var(--text-muted)]',
      },
      size: {
 ...
 * - send: Pastel blue button with rounded-md for message sending (disabled state shows muted background)
 */
