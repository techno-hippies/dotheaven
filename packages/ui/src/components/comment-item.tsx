...
/**
 * CommentItem - Single comment display with avatar and inline content.
 * Designed for comment sections under posts.
 */
...
/**
 * CommentSection - Container for a list of comments with optional title.
 */
