...
execSync(
  `npx wrangler d1 execute session-voice --local --command="INSERT INTO credit_accounts (wallet, base_granted_seconds, bonus_granted_seconds, consumed_seconds, updated_at) VALUES ('${wallet}', 1800, 0, 0, datetime('now'))"`,
