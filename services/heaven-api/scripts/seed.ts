...
console.log('  cd services/heaven-api && wrangler d1 execute ${D1_DATABASE:-heaven-api} --local --file=./scripts/seed.sql')
console.log('')
console.log('To apply remotely:')
console.log('  cd services/heaven-api && wrangler d1 execute ${D1_DATABASE:-heaven-api} --remote --file=./scripts/seed.sql')
