...
async function generateSeedSQL(): Promise<string> {
  ...
  const lines: string[] = [
    ...
    '-- Run with: wrangler d1 execute ${API_CORE_D1_DATABASE:-${D1_DATABASE:-api-core}} --local --file=./scripts/seed.sql',
    '',
...
console.log('  cd services/api-core && wrangler d1 execute ${API_CORE_D1_DATABASE:-${D1_DATABASE:-api-core}} --local --file=./scripts/seed.sql')
console.log('')
console.log('To apply remotely:')
console.log('  cd services/api-core && wrangler d1 execute ${API_CORE_D1_DATABASE:-${D1_DATABASE:-api-core}} --remote --file=./scripts/seed.sql')
