...
///         Tracks (metadata) live in ScrobbleV3; this contract stores encrypted file references.
contract ContentRegistry {
    ...
    function computeContentId(bytes32 trackId, address owner) public pure returns (bytes32) {
        return keccak256(abi.encode(trackId, owner));
    }
