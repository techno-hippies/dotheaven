...
import {SessionEscrowV2} from "../src/SessionEscrowV2.sol";

/// @title DeploySessionEscrowV2
/// @notice Deploy SessionEscrowV2 (TIP-20 token escrow) on Tempo Moderato testnet.
contract DeploySessionEscrowV2Script is Script {
    ...
    function run() external {
        ...
        console2.log("=== Deploying SessionEscrowV2 (TIP-20, Tempo Moderato) ===");
        ...
        SessionEscrowV2 escrow = new SessionEscrowV2(
            paymentToken,
            oracle,
            treasury,
            feeBps,
        ...
        console2.log("");
        console2.log("SessionEscrowV2:", address(escrow));
        console2.log("Final owner:", escrow.owner());
        console2.log("");
        console2.log("Export:");
        console2.log(string.concat("SESSION_ESCROW_V2=", vm.toString(address(escrow))));
