...
/// @title DeployNamesV2
/// @notice Deploy RegistryV2 + RecordsV1 + PremiumNameStore on Tempo.
contract DeployNamesV2Script is Script {
    ...
    function run() external {
        ...
        console2.log("========================================");
        console2.log("Deploying Name Stack V2 on Tempo");
        console2.log("========================================");
        ...
        PremiumNameStore store = new PremiumNameStore(address(registry), alphaUsd, treasury, owner);
        registry.setOperator(nodeHeaven, address(store), true);
        registry.setOperator(nodePirate, address(store), true);
        console2.log("PremiumNameStore deployed at:", address(store));
        ...
        console2.log("  PremiumNameStore:  ", address(store));
        console2.log("");
        ...
        console2.log(string.concat("PREMIUM_NAME_STORE=", vm.toString(address(store))));
