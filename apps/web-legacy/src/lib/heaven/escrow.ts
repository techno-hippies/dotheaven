...
import { SESSION_ESCROW_V1, TEMPO_CHAIN_ID } from '@heaven/core'
...
const escrowAbi = parseAbi([
  ...
  'struct SessionBooking { uint256 slotId; address guest; uint256 amount; uint8 status; uint8 oracleOutcome; bytes32 metricsHash; uint64 attestedAt; uint64 finalizableAt; address challenger; uint256 bondAmount; uint64 disputedAt; }',
