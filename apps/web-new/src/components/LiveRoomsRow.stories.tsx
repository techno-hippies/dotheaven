    ...
    rooms: [
      {
        ...
        listenerCount: 128,
        audienceMode: 'free',
        watchUrl: 'https://session-voice.deletion-backup782.workers.dev/duet/a9f8e9f6-2222-4444-9999-c1b61f730001/watch',
      },
      {
        ...
        watchUrl: 'https://session-voice.deletion-backup782.workers.dev/duet/db9af0f8-2222-4444-9999-c1b61f730002/watch',
      },
    ],
  },
}
