...
internal enum class ProfileTab(val icon: ImageVector, val contentDescription: String) {
  ...
  Playlists(Icons.Rounded.QueueMusic, "Playlists"),
  Scrobbles(Icons.Rounded.Headphones, "Scrobbles"),
  Schedule(Icons.Rounded.CalendarMonth, "Schedule"),
  About(Icons.Rounded.Person, "About"),
}
