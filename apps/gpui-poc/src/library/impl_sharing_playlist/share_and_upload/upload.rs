...
fn track_meta_input_from_row(track: &TrackRow) -> TrackMetaInput {
    TrackMetaInput {
...
fn build_uploaded_track_record(
    owner_address: &str,
    track: &TrackRow,
    response: &Value,
...
fn upload_track_with_diagnostics(
...
fn is_turbo_credit_blocker(raw: &str) -> bool {
