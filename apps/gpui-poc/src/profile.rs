...
pub(super) const BG_PAGE: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.08,
    a: 1.,
...
pub(super) const BG_SURFACE: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.11,
    a: 1.,
};
pub(super) const BG_HOVER: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.16,
    a: 1.,
...
pub(super) const BORDER_SUBTLE: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.21,
    a: 1.,
};
pub(super) const TEXT_PRIMARY: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.98,
    a: 1.,
};
pub(super) const TEXT_SECONDARY: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.83,
    a: 1.,
};
pub(super) const TEXT_MUTED: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.64,
    a: 1.,
};
pub(super) const TEXT_DIM: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.45,
    a: 1.,
};
pub(super) const ACCENT_BLUE: Hsla = Hsla {
    h: 0.62,
    s: 0.93,
    l: 0.76,
    a: 1.,
