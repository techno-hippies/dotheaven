...
fn cli_usage() -> &'static str {
    "Usage:\n  heaven-gpui-poc duet-bridge --room <room_id> --bridge-ticket <ticket> [--worker-url <url>] [--agora-app-id <id>] [--china-cn-only] [--refresh-seconds <n>] [--pulse-source <source_name>]\n\nExample:\n  heaven-gpui-poc duet-bridge --room <room_id> --bridge-ticket <ticket> --worker-url https://session-voice.deletion-backup782.workers.dev"
}
