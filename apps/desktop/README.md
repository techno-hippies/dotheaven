...
# Media resolution gateways (ipfs://, ar://, ls3:// refs)
export HEAVEN_IPFS_GATEWAY_URL="https://ipfs.io"
export HEAVEN_ARWEAVE_GATEWAY_URL="https://arweave.net"
# Optional: if unset, defaults to gateway.s3-node-1.load.network
# export HEAVEN_LOAD_GATEWAY_URL="https://gateway.s3-node-1.load.network"
...
export VOICE_CONTROL_PLANE_URL=https://voice-control-plane.dotheaven.org
# legacy alias (still accepted):
# export HEAVEN_VOICE_WORKER_URL=https://voice-control-plane.dotheaven.org
export HEAVEN_CHAT_WORKER_URL=https://voice-agent.dotheaven.org
