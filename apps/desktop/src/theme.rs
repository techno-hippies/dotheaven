...
pub fn apply_heaven_theme(cx: &mut App) {
    ...
    // -- List --
    theme.list = hex_color("#1c1c1c");
    theme.list_hover = hex_color("#303030");
    theme.list_active = hex_color("#363636");
    ...
    // -- Accordion --
    theme.accordion = hex_color("#1c1c1c");
    theme.accordion_hover = hex_color("#303030");
